          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body mt-3">
                        <form action="<?= base_url() . "admin/paket/import_paket" ?>" method="post" enctype="multipart/form-data">
                ...
                <form action="<?= base_url() . "admin/paket/delete_all_paket" ?>" method="post" enctype="multipart/form-data">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <form action="<?= base_url() . "admin/paket/delete_paket" ?>" method="post" enctype="multipart/form-data">
