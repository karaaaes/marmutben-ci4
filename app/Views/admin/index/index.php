                ...
                <div class="col-12 col-sm-6 col-md-2">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?= $countCategories[3]['jumlah_data']; ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-12 col-sm-6 col-md-2">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?= $countCategories[4]['jumlah_data']; ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-12 col-sm-6 col-md-2">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?= $countCategories[5]['jumlah_data']; ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="progress-group">
                                        Anakan
                                        <span class="float-right"><?= $totalHits[0]['hit']; ?></span>
                                    ...
                                    <div class="progress-group">
                                        Remaja
                                        <span class="float-right"><?= $totalHits[1]['hit']; ?></span>
                                        <div class="progress progress-sm">
                                    ...
                                    <div class="progress-group">
                                        ...
                                        <span class="float-right"><?= $totalHits[2]['hit']; ?></span>
                                        <div class="progress progress-sm">
                                    ...
                                    <div class="progress-group">
                                        Bunting
                                        <span class="float-right"><?= $totalHits[3]['hit']; ?></span>
                                        <div class="progress progress-sm">
                                    ...
                                    <div class="progress-group">
                                        Indukan Hias
                                        <span class="float-right"><?= $totalHits[4]['hit']; ?></span>
                                        <div class="progress progress-sm">
                                    ...
                                    <div class="progress-group">
                                        Bunting Hias
                                        <span class="float-right"><?= $totalHits[5]['hit']; ?></span>
                                        <div class="progress progress-sm">
                                            <div class="progress-bar bg-primary" style="width: 100%"></div>
                                        </div>
                                    </div>
