          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body mt-3">
                        <form action="<?= base_url() . "admin/ongkir/import_ongkir" ?>" method="post" enctype="multipart/form-data">
                ...
                <a href="<?= base_url() . "admin/ongkir/delete_ongkir" ?>" class="btn btn-danger mb-3">Delete All</a>
              </div>
