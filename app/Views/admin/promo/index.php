      ...
      <div class="row">
        ...
        <?php if (session()->getFlashdata('success_message')): ?>
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <div class="card-body">
              <a href="<?= base_url() . "admin/promo/add" ?>" class="btn btn-primary bg-gradient-primary mb-3">Tambah Promo</a>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><img src="<?= base_url() . $promo['image_promo']; ?>" height="100" width="200" alt="image_promo"/></td>
                    <td><?= $promo['kode_promo']; ?></td>
                    <td><?= $promo['jumlah_promo']; ?></td>
                    <td><?= $promo['expired_at']; ?></td>
                    <td>
                      <a href="<?= base_url() . "admin/promo/" . $promo['id'] ?>" class="btn btn-block bg-gradient-warning btn-xs">Edit</a>
                      <form action="<?= base_url() . "admin/promo/action_delete" ?>" method="post" enctype="multipart/form-data">
